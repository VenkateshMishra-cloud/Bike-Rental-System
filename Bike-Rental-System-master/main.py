...
def main():
    ...
    while True:
        ...
        2. Request a bike on hourly basis 5 Rs.
        3. Request a bike on daily basis 20 Rs.
        4. Request a bike on weekly basis 60 Rs.
        5. Return a bike
        6. Exit
        """)
    ...
    print("Thank you for using my bike rental system!")
